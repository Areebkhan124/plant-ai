...
# Grad-CAM is temporarily disabled (see run_inference/compute_gradcam) because
# building/using the Grad-CAM sub-model was spiking memory enough to get the
# process OOM-killed on Railway's trial instance, even before any prediction
# request arrived. Re-enable once running on a host with more available RAM.
grad_model = None
